...
const Page = () => {
  ...
  const startAutoScroll = useCallback(() => {
    const id = setInterval(goToNext, 5000); // Change slide every 5 seconds
  ...
  }, [startAutoScroll, stopAutoScroll]); // Include dependencies
        ...
        >
          ...
          >
            ...
            <div className="flex-none w-full h-96 bg-green-200 justify-center items-center text-white p-6 rounded-lg shadow-md">
              ...
              <Image width={100} height={100} src={image2} alt="image2" className="w-96 h-full" />
            </div>
            <div className="flex-none w-full h-96 bg-purple-200 justify-center items-center text-white p-6 rounded-lg shadow-md">
              ...
              <Image width={1000} height={1000} src={image3} alt="image3" className="w-96 h-full object-cover" />
            </div>
          </div>
